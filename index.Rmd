...
panel_app <-
  ...
  pmap_df(function(id, version) {
    cavalier::get_panelapp_panel(id, version = version)
  }) %>% 
  mutate(
    ...
    url = str_c(
      ...
      if_else(list_id == 'PAA:202', 
              'https://panelapp-aus.org/panels/202/gene/',
...
[Oliver KL, Scheffer IE, Bennett MF, Grinton BE, Bahlo M, Berkovic SF. Genes4Epilepsy: An epilepsy gene resource. Epilepsia. 2023 May;64(5):1368-1375. doi: 10.1111/epi.17547](https://onlinelibrary.wiley.com/doi/10.1111/epi.17547)
